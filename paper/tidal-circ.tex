...
circularization timescale. \todo{Compute the change in convective layer size as
star evolves into subgiant phase}.
...
\todo{Put some actual numbers in here...}
...
We further subselect the \todo{XX} stars with $\logg > 2$ and that pass visual
