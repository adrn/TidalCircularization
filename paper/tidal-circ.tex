...
\begin{description}
    ...
    equal to the median over minimum companion masses, $\med{M_{2,
    \textrm{min}}} = 0.5~\msun$.
...
To compute this quantity, we use a model stellar evolution track to integrate
...
pre-main-sequence phase to the asymptotic giant branch (AGB) phase.
...
1000~\textrm{day}$ is broadly consistent with flat (\citealt{Duchene:2013}).
...
\begin{table}[h]
    ...
    \hline
    \texttt{APOGEE\_ID} & \logg\ & \Teff\ [K] & $P$ [day] & $P/\Psurf$ & $e$ \\
    \hline
    2M05272385+1246432 & 3.55 & 4791 & 1.05 & 1.7 & 0.15\\
    2M11482364+3504215 & 3.47 & 4440 & 3.69 & 3.6 & 0.32\\
    2M15042105+2700026 & 2.41 & 4663 & 36.68 & 2.5 & 0.61\\
    2M16503620-0054432 & 3.52 & 5010 & 3.98 & 3.8 & 0.38\\
    \hline
    \end{tabular}
