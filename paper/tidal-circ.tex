...
We use the $1.4~\msun$ \acronym{MESA} model to integrate \equation~\ref{eq:dlne}
...
% Like \citet{Verbunt:1995}, we find that the dimensionless parameter $f$ is consistent with unity, indicating that tidal circularization of binaries with giant star members is at least qualitatively

TODO: caveats with the above. Stars have a range of masses, companions. But overall looks good and consistent with VP95!
